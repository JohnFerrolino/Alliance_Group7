        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosititionName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PositionRequirementsID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PositionID = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    PositionRequirementsID1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionRequirements", x => x.PositionRequirementsID);
                    table.ForeignKey(
                        name: "FK_PositionRequirements_Position_PositionID",
                        column: x => x.PositionID,
                        principalTable: "Position",
                        principalColumn: "PositionID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PositionRequirements_PositionRequirements_PositionRequirementsID1",
                        column: x => x.PositionRequirementsID1,
                        principalTable: "PositionRequirements",
                        principalColumn: "PositionRequirementsID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionRequirements_PositionRequirementsID1",
                table: "PositionRequirements",
                column: "PositionRequirementsID1");
        }
